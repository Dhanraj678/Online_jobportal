<%@ Page Title="" Language="C#" MasterPageFile="~/home_master_page.master" AutoEventWireup="true" CodeFile="candidate_login_page.aspx.cs" Inherits="login_page" %>
...
<div class="row form-group" style=" width:300px">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="txt_cand_id">CANDIDATE_ID</label>
