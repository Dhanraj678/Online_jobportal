<%@ Page Title="" Language="C#" MasterPageFile="~/home_master_page.master" AutoEventWireup="true" CodeFile="company_login_page.aspx.cs" Inherits="company_login_page" %>
...
<div class="row form-group" style=" width:300px">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="txt_cand_id">COMPANY ID</label>
              ...
              <!-- <input type="text" id="fullname" class="form-control" placeholder="EG.DHANRAJ">-->
                        <asp:TextBox ID="txt_PASSWORD" runat="server" class="form-control" TextMode="Password"  placeholder=""></asp:TextBox>
